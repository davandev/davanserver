...
if __name__ == '__main__':
    ...
    #dev = [65585,65576,65579,65582,65539,65562,65586,65542,65583,65546,65540,65581,65578,65544,65555,65574,65584,65577,65563,65541,65572,65547,65575,65537,65560,65580,65545]
